...
class _GasolinaAppState extends State<GasolinaApp> {
  ...
  static const Color corFundo = Color.fromARGB(255, 143, 0, 164); 
  static const Color corCard = Color.fromARGB(255, 83, 3, 98); 
  static const Color corPrimaria = Color.fromARGB(255, 181, 34, 249); 
  static const Color corSecundaria = Color.fromARGB(255, 234, 180, 255); 
  static const Color corTexto = Color.fromARGB(255, 255, 255, 255); 
  static const Color corTextoCinza = Color.fromARGB(255, 255, 255, 255); 
  static const Color corBorda = Color.fromARGB(255, 219, 101, 255); 
